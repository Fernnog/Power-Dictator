...
export const changelogData = [
    {
        ...
        changes: [
            "Garantia de Instalação PWA: Implementação de botão explícito para instalação nativa no Android/Chrome.",
            "Lançamento do Modo Foco: Nova funcionalidade de leitura expandida para dispositivos móveis, maximizando a área de texto.",
            "UX/UI: Ocultação dinâmica de elementos visuais (ondas sonoras, cabeçalho) durante o Modo Foco para evitar distrações."
        ]
    },
    {
        version: "1.1.0",
